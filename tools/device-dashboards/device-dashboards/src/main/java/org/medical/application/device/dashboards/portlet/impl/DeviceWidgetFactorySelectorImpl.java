 ...
 * 
 */
package org.medical.application.device.dashboards.portlet.impl;
...
public class DeviceWidgetFactorySelectorImpl implements DeviceWidgetFactorySelector {
	...
	/* (non-Javadoc)
	 * @see org.medical.device.portlet.selector.PortletFactorySelector#selectPortletFactory(fr.liglab.adele.icasa.device.GenericDevice, java.util.List)
	 */
	@Override
