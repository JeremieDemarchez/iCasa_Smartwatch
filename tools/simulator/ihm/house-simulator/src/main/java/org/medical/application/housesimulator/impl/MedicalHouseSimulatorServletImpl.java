 ...
 * @author bourretp
 */
@Component(name="SimulatorServlet")
@Provides(specifications = Servlet.class, properties = { @StaticServiceProperty(name = "alias", type = "java.lang.String", value = "/simulator") })
public class MedicalHouseSimulatorServletImpl extends WebContainerServlet implements
   ...
   private String homeType;
    ...
    @Requires(filter = "(component.class=org.medical.application.housesimulator.impl.MedicalHouseSimulatorImpl)")
