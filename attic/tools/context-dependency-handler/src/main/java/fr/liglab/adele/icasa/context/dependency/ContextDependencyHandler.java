...
@org.apache.felix.ipojo.annotations.Handler(name = "requirescontext", namespace = "fr.liglab.adele.icasa.context.handler.annotations")
public class ContextDependencyHandler extends DependencyHandler {

    public static final String NAME_SPACE = "fr.liglab.adele.icasa.context.handler.annotations";
     ...
     */
    private final List<ContextDependency> m_dependencies = new ArrayList<ContextDependency>();
    ...
    @Requires
    private ContextGroupManager m_contextGroupManager;
    
    
    private Map<String, String> privateZoneVariables = new HashMap<String, String>();
     ...
     */
    private boolean checkDependency(ContextDependency dep, PojoMetadata manipulation) throws ConfigurationException {
    ...
    public void configure(Element componentMetadata, Dictionary configuration) throws ConfigurationException {
        ...
        Element[] deps = componentMetadata.getElements("requirescontext", NAME_SPACE);
        ...
        for (int i = 0; deps != null && i < deps.length; i++) {
            ...
            if (identity == null) {
                throw new ConfigurationException("The id attributte is mandatory in requires-context configuration");
            }
            
            String contextGroupId = dependencyElement.getAttribute("contextGroupId");
            
            if (contextGroupId == null) {
                throw new ConfigurationException("The id contextGroupId is mandatory in requires-context configuration");
            }
            ...
            ContextDependency dep = new ContextDependency(this, field, specification,
                    null, false, false, identity, context, policy, comparator, contextGroupId);            
    ...
    public void onCreation(Object instance) {
        for (ContextDependency dep : m_dependencies) {
    ...
    public boolean isPrivateVariable(String variableName) {
        return privateZoneVariables.containsKey(variableName);
    }
    
    public String getInstanceOwner(String variableName) {
        return privateZoneVariables.get(variableName);
    }
    
    public void addPrivateVariableDefinition(String variableName, String dependencyId) {
        privateZoneVariables.put(variableName, dependencyId);
    }
    
    public String getPrivateZoneGroupId(String zoneId) {
        return m_contextGroupManager.isPrivateZone(zoneId);
    }
