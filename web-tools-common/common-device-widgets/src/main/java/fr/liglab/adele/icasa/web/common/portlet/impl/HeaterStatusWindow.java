...
public class HeaterStatusWindow extends DeviceStatusWindow {
   ...
   private static final long serialVersionUID = 7214188369352385316L;
	...
	public HeaterStatusWindow(BaseHouseApplication parent, String deviceSerialNumber) {
	...
	protected void updateInfo(final ServiceReference reference, final GenericDevice device) {
		...
		if (device instanceof Heater) {
			...
			Label locationLabel = new Label(heater.getPowerLevel() + "");
