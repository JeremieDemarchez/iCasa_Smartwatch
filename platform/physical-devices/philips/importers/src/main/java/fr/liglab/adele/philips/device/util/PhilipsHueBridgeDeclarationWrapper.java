...
import static fr.liglab.adele.philips.device.util.Constants.DISCOVERY_PHILIPS_BRIDGE_TYPE;
import static fr.liglab.adele.philips.device.util.Constants.DISCOVERY_PHILIPS_BRIDGE_OBJECT;
