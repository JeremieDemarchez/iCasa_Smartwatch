...
import org.medical.upnp.presence.detector.AbstractPresenceDetectorDevice;
...
public class PresenceDetectorUPNPDeviceProxy extends
	...
	@Bind(aggregate = true, specification = "org.medical.device.presence.PresenceSensor")
	...
	@SuppressWarnings("unused")
	@Unbind(aggregate = true, specification = "org.medical.device.presence.PresenceSensor")
