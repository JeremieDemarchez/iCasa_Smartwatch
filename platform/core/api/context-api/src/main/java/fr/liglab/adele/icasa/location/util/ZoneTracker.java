...
public class ZoneTracker implements ZoneTrackerCustomizer {
    ...
    public ZoneTracker (BundleContext context,  ZoneTrackerCustomizer customizer, final String... mandatoryVariables){
        ...
        this.zoneFilter = (mandatoryVariables.length == 0)? new DefaultTrueFilter(): new MandatoryVariableFilter(mandatoryVariables);
    }
     ...
     * This method is called when a zone has been added in the managed list (after addingZone) and if the zone has not disappeared before during the callback.
     *
    ...
    class Tracked extends HashMap<String, Zone> {
        ...
        /**
         * Sets initial list of services into tracker before ServiceEvents begin to be received. This method must be called from zoneTracker.open while synchronized on this object in the same synchronized block as the addServiceListener call.
        ...
        /**
         * Tracks the initial list of services. This is called after ServiceEvents can begin to be received. This method must be called from zoneTracker.open while not synchronized on this object after the addServiceListener call.
         */
        protected void trackInitialZones() {
            while (true) {
                ...
                trackAdding(zone); // Begin tracking it. We call trackAdding since we have already put the reference in the adding list.
            }
        }
        ...
        /**
         * Common logic to add a zone to the tracker used by track and trackInitialZones.
         * The specified zone must have been placed in the adding list before calling this method.
         * @param zone the zone to be tracked.
         */
        ...
        /**
         * Discontinues tracking the zone.
         * Do nothing if specified zone is not tracked.
