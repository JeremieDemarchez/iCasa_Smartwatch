 ...
 */
package fr.liglab.adele.icasa.access.utils;
...
public class XMLUtils {
     ...
     * 
     * @see #writeMapXml(java.util.Map, String, XmlSerializer)
     * @see #writeListXml
     * @see #writeValueXml
     * @see #readMapXml
     */
     ...
     *            Where to write the XML data.
     *
     * @see #writeListXml(java.util.List, String, XmlSerializer)
     * @see #writeMapXml
     * @see #writeValueXml
     * @see #readListXml
     */
    ...
    public static final Map<String, Object> readMapXml(InputStream in)
            throws XmlPullParserException, IOException {
    ...
    private static final Object readThisValueXml(XmlPullParser parser,
        ...
        while ((eventType = parser.next()) != parser.END_DOCUMENT) {
            if (eventType == parser.END_TAG) {
                ...
                throw new XmlPullParserException(
                        "Unexpected end tag in <" + tagName + ">: "
                                + parser.getName());
            }
            else if (eventType == parser.TEXT) {
                throw new XmlPullParserException(
                        "Unexpected text in <" + tagName + ">: "
                                + parser.getName());
            }
            else if (eventType == parser.START_TAG) {
                throw new XmlPullParserException(
